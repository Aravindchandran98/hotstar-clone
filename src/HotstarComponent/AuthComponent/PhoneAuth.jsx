         ...
         try{
             let captchaVerifier = new firebase.auth.RecaptchaVerifier('recaptcha-container');
               ...
               .then( confirmationResult => {
                  ...
                  let code = window.prompt("enter verification code");
      ...
      <section className="authBlock">
        <section className="card col-md-3 mx-auto">
          <article className="form-block">
            <h5 className="h5 font-weight-bold p-4">Enter your mobile number</h5>
            <div className="card-body">
              <form onSubmit={this.handleSubmit}>
                ...
                <div className="form-group">
                  <button className="btn btn-block btn-outline-primary">continue</button>
                </div>
                <div className="form-group">
                    <span> 
                        Go back to
