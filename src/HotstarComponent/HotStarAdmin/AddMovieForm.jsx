...
class AddMovieForm extends Component {
    constructor(props) {
        ...
        this.state = { 
            ...
            type: "",
            duaration: "",
            video: "",//no-null we need to put empty string because of uncontrolled form error
            url:"",
            progress:0,
            barStatus:false,
            minVal:0,
    ...
    handleSubmit = (e) =>{
       ...
       try {
           ...
           //MovieTask
           let MovieTask = firebase.storage().ref(`/hotstarMovies/${video.name}`).put(video);
           //events
           MovieTask.on(
               "state_changed",
               snapShot => {
               ...
               () => {
                   ...
                   .then( url => {
                       this.setState({ url }, () => {
                        ...
                        toast.success("sucessfully movie created");
    ...
    render() {
       ...
       let progressBar = (
           <Fragment>
        <progress max="100" value={ progress } style={{width:"100%" , position: "absolute", top: "30%"}}>
            {progress}
        </progress>
        <span>{progress}</span>
        </Fragment>
